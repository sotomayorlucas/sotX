...
#!/bin/busybox sh
/bin/busybox echo "=== sotOS guest /init alive ==="
...
cd /tmp/gird
find . | cpio -o -H newc | gzip > /mnt/c/Users/sotom/sotOS/target/guest-initramfs.cpio.gz
echo "=== initramfs DONE ==="
ls -la /mnt/c/Users/sotom/sotOS/target/guest-initramfs.cpio.gz
