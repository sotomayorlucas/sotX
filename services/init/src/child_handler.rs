                ...
                match result {
                    Ok((new_ep, _tc)) => {
                        ...
                        if pid > 0 && pid <= MAX_PROCS {
                            ...
                            crate::process::set_personality(pid, LAST_EXEC_PERSONALITY.load(core::sync::atomic::Ordering::Acquire));
            ...
            SYS_CLONE => {
                ...
                if flags & CLONE_VM == 0 {
                    ...
                    PROCESSES[cidx].personality.store(
                        PROCESSES[pidx].personality.load(core::sync::atomic::Ordering::Acquire),
